...
/**
 * 神之砍杀面配置界面：3×2 方向磁贴 + 返回按钮（参考神之熔炉面配置）。
 */
public class GodSlaughterConfigScreen extends AbstractContainerScreen<GodSlaughterConfigMenu>
{
    ...
    public GodSlaughterConfigScreen(GodSlaughterConfigMenu menu, Inventory playerInventory, Component title)
    {
    ...
    private void drawDirectionTile(GuiGraphics gui, int bx, int by, int dir)
    {
        ...
        gui.fill(bx + 1, by + 1, bx + 5, by + TILE_H - 1, stripeColor);
