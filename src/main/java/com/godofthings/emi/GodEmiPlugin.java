...
public class GodEmiPlugin implements EmiPlugin
{
    ...
    private void addCookingRecipes(EmiRegistry registry, RecipeType<? extends AbstractCookingRecipe> type)
    {
    ...
    public static class GodFurnaceEmiRecipe implements EmiRecipe
    {
        ...
        public GodFurnaceEmiRecipe(AbstractCookingRecipe recipe, RegistryAccess registryAccess)
        {
            this.recipe = recipe;
