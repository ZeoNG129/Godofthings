...
public class ValueButtonsDouble {
	...
	private static final ResourceLocation subtract = new ResourceLocation(JustDireThings.MODID,
	...
	public ValueButtonsDouble(int x, int y, double startingValue, double minValue, double maxValue, Font font,
			BiConsumer<ValueButtonsDouble, Double> onPress) {
		this(x, y, startingValue, minValue, maxValue, Component.empty(), font, onPress);
	}

	public ValueButtonsDouble(int x, int y, double startingValue, double minValue, double maxValue, Component label,
			Font font, BiConsumer<ValueButtonsDouble, Double> onPress) {
		...
		// Value Display
		this.valueDisplay = new StringWidget(x + 11, y + 2, 20, font.lineHeight,
				Component.literal(String.valueOf(startingValue)), font);
