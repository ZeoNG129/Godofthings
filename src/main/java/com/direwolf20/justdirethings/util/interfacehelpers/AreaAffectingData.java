...
public class AreaAffectingData {
	...
	public boolean equals(Object o) {
		...
		return xRadius == that.xRadius && yRadius == that.yRadius && zRadius == that.zRadius && xOffset == that.xOffset
				&& yOffset == that.yOffset && zOffset == that.zOffset && renderArea == that.renderArea;
	}
