...
| 神之剑 God Sword | 代码级秒杀，不论对象血量一击必杀（不可破坏） |
| 神之炮 God Cannon | 电磁炮：左键贯穿光束（128 格）、右键三层蓄力范围炮（半径 4/7/12 格） |
| 神之加速 God Accelerator | 放入神之系列机器提升并行数：每 1 个 16 倍，一组 64 个 = **1024 倍** |
| 造化垂青之杖 God Favor Wand | 多模式工具杖：连锁挖掘 / 强制破坏 / 时运 / 精准采集 / 一击必杀 / 无敌 / 捕捉；模式转盘；AE2 存储优先；扳手 / 螺丝刀 / 木槌 / 撬棍 / 锤 五种工具形态 |
...
src/main/java/com/godofthings/
  ...
  ├─ item/                   # 物品（神之剑/神之炮/神之加速/造化垂青之杖/护甲…）
  ├─ menu/ client/screen/    # 容器菜单与屏幕
  ├─ modes/                  # 造化垂青之杖模式系统
  ├─ network/                # 网络包（模式转轮 / 造化垂青之杖 / 神之炮光束）
